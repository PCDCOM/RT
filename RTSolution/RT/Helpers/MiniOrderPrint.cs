...
namespace PrintingSystem
{
    public class MiniOrderPrint
    {
        ...
        void pdoc_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            string[] headerTxts = { "No", "Item", "Qt", "TA." };
            ...
            new SolidBrush(Color.Black), startX, startY + 80);
        }
        ...
        void DrawRow(int startX, int startY, Graphics graphics, Pen lightPen, string[] txts, Font font)
        {
            ...
            var rectObjects = new[] { 
                new { rect = new RectangleF (startX , startY , celltWidth = 22, 20), txt = txts[0], alignment = StringAlignment.Far },
                new { rect = new RectangleF (startX = startX + celltWidth, startY, celltWidth =  110, 20), txt = txts[1] ,alignment = StringAlignment.Near},
                new { rect = new RectangleF (startX = startX + celltWidth, startY, celltWidth =  20, 20), txt = txts[2] ,alignment = StringAlignment.Far},
                new { rect = new RectangleF (startX = startX + celltWidth, startY, celltWidth =  28, 20), txt =txts[3] ,alignment = StringAlignment.Center},
            };
