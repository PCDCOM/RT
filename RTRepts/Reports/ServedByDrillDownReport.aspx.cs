...
namespace RT
{
    public partial class ServedByDrillDownReport : System.Web.UI.Page
    {
        ...
        private void LoadReport()
        {
            ...
            rptVwrServedByDrillDown.LocalReport.ReportPath = string.Format(Server.MapPath(@"rdl\ServedByDrillDownReport.rdl"));
            ...
            using (StreamReader rdlcSR = new StreamReader(Server.MapPath(@"rdl\SalesDrillDownReport.rdl")))
            {
