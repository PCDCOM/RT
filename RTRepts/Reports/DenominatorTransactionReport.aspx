<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DenominatorTransactionReport.aspx.cs" Inherits="RT.DenominatorTransactionReport" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <h1 align="center">Denominator Transaction Report</h1>
        <table style="border-collapse:collapse; border-color:#CCCCCC; border-style:solid; border-width:1pt">
            <tr>
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td><asp:HyperLink ID="Home" runat="server" NavigateUrl="~/ReportList.aspx">Home</asp:HyperLink></td>
            </tr>          
        </table>

    <rsweb:ReportViewer ID="rptVwrDenominatorTransaction" runat="server" Height="564px" Width="1058px"></rsweb:ReportViewer>
